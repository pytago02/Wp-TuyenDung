...
<!-- The details of a specific product for editing, based on the product ID -->
		...
		<?php $Payment = $wpdb->get_row( $wpdb->prepare( "SELECT * FROM $ewd_feup_payments_table_name WHERE Payment_ID ='%d'", intval( $_GET['Payment_ID'] ) ) ); ?>
				...
				<div class="form-wrap EditField">
						...
						<form id="addtag" method="post" action="admin.php?page=EWD-FEUP-options&Action=EWD_FEUP_EditField&DisplayPage=Payment" class="validate" enctype="multipart/form-data">
								...
								<div class="form-field form-required">
									...
									<input name="User_ID" class='ewd-admin-regular-text' id="User_ID" type="text" value="<?php echo esc_attr( $Payment->User_ID ); ?>" size="60" />
								...
								<div class="form-field form-required">
									...
									<input name="Username" class='ewd-admin-regular-text' id="Username" type="text" value="<?php echo esc_attr( $Payment->Username ); ?>" size="60" />
								...
								<div class="form-field form-required">
									...
									<input name="Payer_ID" class='ewd-admin-regular-text' id="Payer_ID" type="text" value="<?php echo esc_attr( $Payment->Payer_ID ); ?>" size="60" />
								...
								<div class="form-field form-required">
									...
									<input name="Payment_Receipt_Number" class='ewd-admin-regular-text' id="Payment_Receipt_Number" type="text" value="<?php echo esc_attr( $Payment->PayPal_Receipt_Number ); ?>" size="60" />
								...
								<div class="form-field form-required">
									...
									<input name="Payment_Date" class='ewd-admin-regular-text' id="Payment_Date" type="datetime" value="<?php echo esc_attr( $Payment->Payment_Date ); ?>" size="60" />
								...
								<div class="form-field form-required">
									...
									<input name="Next_Payment_Date" class='ewd-admin-regular-text' id="Next_Payment_Date" type="datetime" value="<?php echo esc_attr( $Payment->Next_Payment_Date ); ?>" size="60" />
								...
								<div class="form-field form-required">
									...
									<input name="Payment_Amount" class='ewd-admin-regular-text' id="Payment_Amount" type="text" value="<?php echo esc_attr( $Payment->Payment_Amount ); ?>" size="60" />
								...
								<div class="form-field form-required">
									...
									<input name="Discount_Code_Used" class='ewd-admin-regular-text' id="Discount_Code_Used" type="text" value="<?php echo esc_attr( $Payment->Discount_Code_Used ); ?>" size="60" />
