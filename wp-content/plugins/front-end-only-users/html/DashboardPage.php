...
<div id="ewd-feup-dashboard-content-area">
	...
	<div id="ewd-feup-dashboard-content-left">
		...
		<?php if ($EWD_FEUP_Full_Version != "Yes" or get_option("EWD_FEUP_Trial_Happening") == "Yes") { 
			$premium_info = '<div class="ewd-feup-dashboard-new-widget-box ewd-widget-box-full">';
			$premium_info .= '<div class="ewd-feup-dashboard-new-widget-box-top">';
			...
			echo apply_filters( 'ewd_dashboard_top', $premium_info, 'FEUP', 'http://www.etoilewebdesign.com/plugins/front-end-only-users/#buy' );
		}	?>
		...
		<div class="ewd-feup-dashboard-new-widget-box ewd-widget-box-full" id="ewd-feup-dashboard-support-widget-box">
			...
			<div class="ewd-feup-dashboard-new-widget-box-bottom">
				<ul class="ewd-feup-dashboard-support-widgets">
					...
					<li>
						<a href="https://www.etoilewebdesign.com/support-center/?Plugin=FEUP&Type=FAQs" target="_blank">
					...
					<li>
						<a href="https://www.etoilewebdesign.com/support-center/" target="_blank">
							...
							<div class="ewd-feup-dashboard-support-widgets-text">Get Support</div>
						</a>
					</li>
				</ul>
			</div>
			...
			<div class="ewd-feup-dashboard-new-widget-box ewd-widget-box-full" id="ewd-feup-dashboard-guarantee-widget-box">
				<div class="ewd-feup-dashboard-new-widget-box-top">
					<div class="ewd-feup-dashboard-guarantee">
						...
						<div class="ewd-feup-dashboard-guarantee-text">If you're not 100% satisfied with the premium version of our plugin - no problem. You have 14 days to receive a FULL REFUND. We're certain you won't need it, though.</div>
					</div>
				</div>
			</div>
		<?php } ?>
	...
	<div id="ewd-feup-dashboard-content-right">
		...
		<?php if ($EWD_FEUP_Full_Version != "Yes" or get_option("EWD_FEUP_Trial_Happening") == "Yes") { ?>
			<div class="ewd-feup-dashboard-new-widget-box ewd-widget-box-full" id="ewd-feup-dashboard-get-premium-widget-box">
				...
				<?php if ( get_option("EWD_FEUP_Trial_Happening") == "Yes" ) { do_action( 'ewd_trial_happening', 'FEUP' ); } ?>
				...
				<div class="ewd-feup-dashboard-new-widget-box-bottom">
					...
					<?php if ( ! get_option("EWD_FEUP_Trial_Happening") ) { 
						...
						echo apply_filters( 'ewd_trial_button', $trial_info, 'FEUP' );
					} ?>
				</div>
			</div>
		<?php } ?>
...
<div id="ewd-feup-dashboard-new-footer-two">
	<div class="ewd-feup-dashboard-new-footer-two-inside">
		...
		<ul class="ewd-feup-dashboard-new-footer-two-menu">
			...
			<li><a href="https://www.etoilewebdesign.com/support-center/?Plugin=FEUP&Type=FAQs" target="_blank">Documentation</a></li>
