				...
				<div class="ewd-feup-admin-styling-subsection">
					<div class="ewd-admin-labelling-section">
						...
						<label>
							...
							<input type='text' name='feup_label_level_select_message' value='<?php echo $feup_Label_Level_Select_Message; ?>' <?php if ($EWD_FEUP_Full_Version != "Yes" and $First_Install_Version >= 2.7) {echo "disabled";} ?> />
						</label>
						<label>
