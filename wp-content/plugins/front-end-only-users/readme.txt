...
Tags: front end user, front end users, front-end user, front-end users, frontend user, frontend users, front end, frontend, user levels, user roles, custom user roles, user management, membership, paid membership, login, login form, registration, registration form, user profile, custom user profile, user import, user export, registration shortcode, login shortcode, user shortcode, restrict, premium content, front-end login, front-end edit profile, front-end user registration
...
<em>Includes Gutenberg blocks for the following features: <strong>register</strong>, <strong>login</strong>, <strong>logout</strong>, <strong>user search</strong>, <strong>user list</strong>, <strong>edit account</strong>, <strong>forgot password</strong> and <strong>confirm forgot password</strong>!</em>
...
* Italian (<href="http://lineapixel.it">Thanks to Christian P.</a>)
* Russian
...
* Our documentation, here: https://www.etoilewebdesign.com/support-center/?Plugin=FEUP&Type=FAQs
...
= 3.2.29 (2024-08-28) =
- Security update. Updated escaping. 
