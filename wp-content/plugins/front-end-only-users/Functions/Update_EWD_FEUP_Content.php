				...
				switch ($_GET['Action']) {
    				case "EWD_FEUP_AddUser":
						...
						case "EWD_FEUP_DeleteUser":
								$feup_message = Delete_EWD_FEUP_User( intval( $_GET['User_ID'] ) );
								break;
						...
						case "EWD_FEUP_DeleteField":
								$feup_message = Delete_EWD_FEUP_Field( intval( $_GET['Field_ID'] ) );
								break;
						...
						case "EWD_FEUP_DeletePayment":
								$feup_message = Delete_EWD_FEUP_Payment( intval( $_GET['Payment_ID'] ) );
								break;
						...
						case "EWD_FEUP_DeleteLevel":
								$feup_message = Delete_EWD_FEUP_Level( intval( $_GET['Level_ID'] ) );
								break;
						...
						case "EWD_FEUP_OneClickInstall":
								...
								break;
						default:
								//$feup_update_message = __("The form has not worked correctly. Please contact the plugin developer.", 'front-end-only-users');
								break;
				}
		}
}
