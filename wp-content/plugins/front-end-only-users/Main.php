...
function EWD_FEUP_Add_FrontEnd_Scripts() {
	...
	if (get_option("EWD_FEUP_Payment_Gateway") == "Stripe") {
		...
		wp_register_script('stripe', EWD_FEUP_CD_PLUGIN_URL . '/js/stripe.js', array( 'jquery' ));
		wp_register_script('stripe-processing', EWD_FEUP_CD_PLUGIN_URL . '/js/stripe-processing.js', array( 'jquery' ));
