	...
	public function init_fields() {
		...
		$this->fields = apply_filters(
			...
			[
				'job'     => [
					'job_title'           => [
						'label'       => __( 'Tiêu đề', 'wp-job-manager' ),
						'type'        => 'text',
						'required'    => true,
						'placeholder' => '',
						'priority'    => 1,
					...
					'job_location'        => [
						'label'       => __( 'Địa chỉ', 'wp-job-manager' ),
						'description' => __( 'Leave this blank if the location is not important', 'wp-job-manager' ),
						'type'        => 'text',
						'required'    => false,
						'placeholder' => __( 'Ví dụ: "Hà Nội"', 'wp-job-manager' ),
						'priority'    => 2,
					],
					'remote_position'     => [
						'label'       => __( 'Làm việc từ xa', 'wp-job-manager' ),
						'description' => __( 'Chọn nếu đây là một vị trí từ xa.', 'wp-job-manager' ),
						'type'        => 'checkbox',
						'required'    => false,
						'priority'    => 3,
					],
					'job_type'            => [
						'label'       => __( 'Loại công việc', 'wp-job-manager' ),
						'type'        => $job_type,
						'required'    => true,
						'placeholder' => __( 'Chọn loại công việc…', 'wp-job-manager' ),
						'priority'    => 4,
						'default'     => 'full-time',
						'taxonomy'    => \WP_Job_Manager_Post_Types::TAX_LISTING_TYPE,
					],
					'job_category'        => [
						'label'       => __( 'Danh mục công việc', 'wp-job-manager' ),
					...
					'job_salary'          => [
						'label'       => __( 'Lương', 'wp-job-manager' ),
						'type'        => 'text',
						'required'    => false,
						'placeholder' => __( 'Ví dụ: 20.000.000', 'wp-job-manager' ),
						'priority'    => 8,
					],
					'job_salary_currency' => [
						'label'       => __( 'Tiền lương', 'wp-job-manager' ),
						'type'        => 'text',
						'required'    => false,
						'placeholder' => __( 'Ví dụ: VND', 'wp-job-manager' ),
				...
				'company' => [
					'company_name'    => [
						'label'       => __( 'Tên công ty', 'wp-job-manager' ),
						'type'        => 'text',
						'required'    => true,
						'placeholder' => __( 'Nhập tên công ty', 'wp-job-manager' ),
						'priority'    => 1,
					],
					'company_website' => [
					...
					'company_tagline' => [
						'label'       => __( 'Dòng giới thiệu', 'wp-job-manager' ),
						'type'        => 'text',
						'required'    => false,
						'placeholder' => __( 'Mô tả ngắn gọn công ty của bạn', 'wp-job-manager' ),
						'maxlength'   => 64,
						'priority'    => 3,
					],
					'company_video'   => [
						...
						'sanitizer'   => 'url',
						'required'    => false,
						'placeholder' => __( 'Liên kết tới video về công ty của bạn', 'wp-job-manager' ),
						'priority'    => 4,
					],
					'company_twitter' => [
