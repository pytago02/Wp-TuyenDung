				...
				<?php foreach ( $jobs as $job ) : ?>
					<div class="jm-dashboard-job">
						...
						<div class="jm-dashboard-job-column actions job-dashboard-job-actions">
							...
							// Thêm nút xem danh sách ứng viên cho từng công việc
							$actions_html .= '<a href="' . esc_url(home_url('/danh-sach-ung-vien?job_id=' . $job->ID)) . '" class="jm-dashboard-action jm-ui-button--link">Xem ứng viên</a>' . "\n";
