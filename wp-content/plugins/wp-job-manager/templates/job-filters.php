...
<form class="job_filters">
	...
	<div class="search_jobs">
		...
		<div class="search_keywords">
			...
			<input type="text" name="search_keywords" id="search_keywords" placeholder="<?php esc_attr_e( 'Từ khoá', 'wp-job-manager' ); ?>" value="<?php echo esc_attr( $keywords ); ?>" />
		</div>
		...
		<?php if( apply_filters( 'job_manager_job_filters_show_remote_position', get_option('job_manager_enable_remote_position', true ), $atts ) ) : ?>
			<div class="search_remote_position">
				...
				<label for="remote_position" id="remote_position_label"><?php esc_html_e( 'Chỉ có vị trí từ xa', 'wp-job-manager' ); ?></label>
			</div>
		<?php endif; ?>
		...
		?>
			<div class="search_submit">
				<input type="submit" value="<?php esc_attr_e( 'Tìm kiếm', 'wp-job-manager' ); ?>">
			</div>
		<?php endif; ?>
...
<noscript><?php esc_html_e( 'Trình duyệt của bạn không hỗ trợ JavaScript hoặc nó bị vô hiệu hóa.JavaScript phải được bật để xem danh sách.', 'wp-job-manager' ); ?></noscript>
